...
export async function registerIdentity(
    ...
    return await uow.execute<RegisterIdentityResult>(async (uow) => {
        ...
        const emailBody = `Your OTP code is: ${otpValue}. It will expire in 10 minutes.`;

        try {
            await sendEmail(payload.email!, emailSubject, emailBody, "");
        } catch (error) {
