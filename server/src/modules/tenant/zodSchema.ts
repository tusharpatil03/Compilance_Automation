...
export const apiKeyStatusEnum = z.enum(["active", "inactive", "revoked"] as const);
...
export type TenantApiKeyChangeStatusInput = z.infer<typeof tenantApiKeyChangeStatusSchema>;
...
export type TenantWebhookCreateInput = z.infer<typeof tenantWebhookCreateSchema>;
