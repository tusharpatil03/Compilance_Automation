...
export function injectParamsIntoBody(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        sendErrorResponse(res, new ApiError(ErrorCode.INTERNAL_ERROR, "Failed to inject parameters into request body", 500));
    }
}
