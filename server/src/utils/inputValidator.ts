...
export const validagteBody = <T>(schema: ZodSchema<T>, source: ValidationSource = "body") =>
        (req: Request, res: Response, next: NextFunction) => {
            try {
                ...
                console.log(e);
                sendErrorResponse(res, new ApiError(ErrorCode.VALIDATION_ERROR, "invalid query", 400));
            }
        };
