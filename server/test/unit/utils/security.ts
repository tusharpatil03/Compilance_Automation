import { hashPassword, generateApiKey, comparePassword, compareApiKeyHash, encryptData, hashApiKey, generateJWTToken } from '../../../src/utils/security';
...
describe('Security Utils', () => {
    describe('hashPassword and comparePassword', () => {
        ...
        it('should compare password correctly', async () => {
            ...
            const isNotMatch = comparePassword('wrong_password', hashedPassword, salt);
    ...
    describe('generateJWTToken', () => {
        ...
        it('should throw when jwt secret is missing', () => {
            ...
            expect(() => generateJWTToken(payload)).toThrow('JWT secret key is not defined in environment variables');
        });
    });
