...
export const listApiKeys = async (
  ...
  try {
    ...
    const message = getErrorMessage(error, "Failed to fetch API keys. Please check your network connection");
    return {
      ok: false,
...
export const createApiKey = async (
  ...
  try {
    ...
    const message = getErrorMessage(error, "Failed to create API key. Please check your network connection");
    return {
      ok: false,
      error: new NetworkError(message),
    }
...
export const deactivateApiKey = async (
  ...
  try {
    ...
    const message = getErrorMessage(error, "Failed to deactivate API key. Please check your network connection");
    return{
      ok: false,
      error: new NetworkError(message),
    }
...
export const deleteApiKey = async (
  ...
  try {
    ...
    const message = getErrorMessage(error, "Failed to delete API key. Please check your network connection");
