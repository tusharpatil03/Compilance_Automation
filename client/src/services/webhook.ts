...
import type { CreateWebhookRequest, Webhook, WebhookListParams } from "../features/webhooks/types/types";
...
export async function createWebHook(
    ...
    try {
        ...
        const message = getErrorMessage(error, "Failed to create webhook. Please check your network connection");
        return {
            ok: false,
...
export async function listWebhooks(
    ...
    try {
        ...
        const message = getErrorMessage(error, "Failed to fetch webhooks. Please check your network connection");
        return {
            ok: false,
            error: new NetworkError(message),
        };
...
export async function deleteWebhook(
    ...
    try {
        ...
        const message = getErrorMessage(error, "Failed to delete webhook. Please check your network connection");
        return {
            ok: false,
            error: new NetworkError(message),
        };
